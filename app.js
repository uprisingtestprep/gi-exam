/* GI Exam Simulator — Application Logic */

const ACCESS_CODE  = "GI9000";
const EXAM_SECONDS = 36000;
const PASSING_PCT  = 72;
const STORAGE_KEY  = "gi_exam_state_v1";
const SIM_Q_COUNT  = 240;  // simulator serves this project's configured pool size (config.json exam.sim_questions)
const DOMAIN_LABELS = {"procedures_periprocedural": "procedures_periprocedural", "esophageal_disorders": "esophageal_disorders", "gastric_duodenal_disorders": "gastric_duodenal_disorders", "ibd_immune_disorders": "ibd_immune_disorders", "motility_disorders": "motility_disorders", "neoplastic_disorders": "neoplastic_disorders", "liver_disorders": "liver_disorders", "pancreas_biliary_disorders": "pancreas_biliary_disorders", "gut_brain_disorders": "gut_brain_disorders", "nutrition": "nutrition", "other_disorders": "other_disorders"};  // maps domain key -> human-readable label for display
